...
func (Client) GetUserExecute(_arg0 users.GetUserRequest) (*users.GetUserResponse, *http.Response, error) {
	...
	userID := requestInt64(_arg0, "userID")
...
func (Client) SendMessageExecute(_arg0 messages.SendMessageRequest) (*messages.SendMessageResponse, *http.Response, error) {
	...
	recipient := zulip.Recipient{}
	if value := requestRecipientPtr(_arg0, "to"); value != nil {
		recipient = *value
	}
	var recipientType *zulip.RecipientType
	if value := requestRecipientTypePtr(_arg0, "recipientType"); value != nil {
		valueCopy := *value
		recipientType = &valueCopy
	}
	content := ""
	if value := requestStringPtr(_arg0, "content"); value != nil {
		content = *value
	}
	topic := ""
	if value := requestStringPtr(_arg0, "topic"); value != nil {
		topic = *value
	}
